...
function enterGame(value) {
  window.location.replace(`http://51.15.98.160/chess/enterGame?value=${value}`);
}

function enterGameAsWhite() {
  window.location.replace(`http://51.15.98.160/chess/RegisterGame?playerColor=WHITE&wtoken=${newGame.p1_token}&btoken=${newGame.p2_token}`);
}

function enterGameAsBlack() {
  window.location.replace(`http://51.15.98.160/chess/RegisterGame?playerColor=BLACK&wtoken=${newGame.p1_token}&btoken=${newGame.p2_token}`);
}
